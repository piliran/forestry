...
<body>
    <div class="h-full bg-gray-200 p-8">
        ...
        <div class="my-4 flex flex-col 2xl:flex-row space-y-4 2xl:space-y-0 2xl:space-x-4">
            <div class="flex flex-col w-full 2xl:w-2/3">
                <div class="flex-1 bg-white rounded-lg shadow-xl p-8">
                    <h4 class="text-xl text-gray-900 font-bold">About Department</h4>
            ...
            <div class="w-full flex flex-col 2xl:w-1/4">
                <div class="flex-1 bg-white rounded-lg shadow-xl p-8">
                    ...
                    <div class="flex flex-col items-center">
                        <img src="https://vojislavd.com/ta-template-demo/assets/img/profile.jpg" class="mt-5 w-40 border-4 border-white rounded-full">
            ...
            <div class="flex flex-col w-full 2xl:w-1/4">
                <div class="flex-1 bg-white rounded-lg shadow-xl p-8">
        ...
        <div class="bg-white rounded-lg shadow-xl p-8">
            <div class="flex items-center justify-between">
                <h4 class="text-xl text-gray-900 font-bold">Members of Staff (532)</h4>
