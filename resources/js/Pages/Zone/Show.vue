...
<template>
    <AppLayout title="Zone Details">
        <div>
            ...
            <div class="h-full">
                <div
                    class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-8 mt-4"
                >
                    <!-- Staff Card -->
                    <div
                ...
                >
                    ...
                    >
                        ...
                        <div v-if="staffList.length > 0" class="p-2">
                            <div
                                class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-4 xl:grid-cols-4 2xl:grid-cols-4 gap-8 mt-8"
                            >
                                <div
