    ...
    <div>
        ...
        >
          ...
          <Column header="Action" :exportable="false" style="min-width: 12rem">
            <template #body="slotProps">
              <Link :href="'/zones/' + slotProps.data.id" preserve-scroll>
      ...
      >
        <div class="flex flex-col gap-6">
          <div>
            <label for="name" class="block font-bold mb-3"> Zone Name </label>
            <InputText
              id="name"
              ...
              fluid
            />
            <small v-if="submitted && !zone.name" class="text-red-500">
              Zone Name is required.
            </small>
          </div>

          <div class="col-12 md:col-6">
            <label for="district" class="block font-bold mb-2">Department</label>
            <Select
              id="id"
              ...
              filter
            />
            <small v-if="submitted && !zone.department_id" class="text-red-500">
          ...
          <div>
            ...
            <InputText
              ...
              fluid
            />
            <small v-if="submitted && !zone.phone" class="text-red-500">
              Phone is required.
            </small>
          </div>
          <div>
            ...
            <InputText
              ...
              fluid
            />
            <small v-if="submitted && !zone.location" class="text-red-500">
          ...
          <div>
            ...
            <InputText
              ...
              fluid
            />
            <small v-if="submitted && !zone.website" class="text-red-500">
              Website is required.
            </small>
          </div>
          <div class="col-12 md:col-6">
            ...
            <Select
              ...
              filter
            />
            <small v-if="submitted && !zone.contact_person" class="text-red-500">
        ...
        <template #footer>
          ...
          <div>
            ...
            />
            <Button v-else label="Save" icon="pi pi-check" @click="saveZone" />
          </div>
        </template>
      </Dialog>
      ...
      >
        ...
        <template #footer>
          <Button label="No" icon="pi pi-times" text @click="deleteZoneDialog = false" />
          <div>
            <ProgressSpinner
              v-if="loading"
              style="width: 30px; height: 30px"
              ...
              aria-label="Custom ProgressSpinner"
            />
            <Button v-else label="Yes" icon="pi pi-check" @click="deleteZone" />
          </div>
        </template>
      </Dialog>
      ...
      >
        <div class="flex items-center gap-4">
          <i class="pi pi-exclamation-triangle !text-3xl" />
          <span> Are you sure you want to delete the selected Zones? </span>
        </div>
        <template #footer>
          <Button label="No" icon="pi pi-times" text @click="deleteZoneDialog = false" />
          <div>
...
const saveZone = async () => {
  ...
  if (zone?.value?.name?.trim()) {
    ...
    try {
      if (zone.value.id) {
        const response = await axios.put(`/zones/${zone.value.id}`, zone.value);
